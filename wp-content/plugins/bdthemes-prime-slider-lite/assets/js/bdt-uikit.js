...
(function (global, factory) {
    ...
    */
    ...
    function instanceAPI (bdtUIkit) {
        ...
        var componentName = cacheFunction(function (name) { return bdtUIkit.prefix + hyphenate(name); });
...

            {
                ...
                read: function(ref) {
                    ...
                    this.elements.forEach(function (el) {
                        ...
                        if (!el[stateKey$1]) {
                            el[stateKey$1] = {cls: data(el, 'bdt-scrollspy-class') || this$1.cls};
                        }

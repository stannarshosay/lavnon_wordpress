...
if( ! defined( 'WCPSCWC_VERSION' ) ) {
	define( 'WCPSCWC_VERSION', '2.6.3' ); // Version of plugin
}
...
if( ! defined( 'WCPSCW_PLUGIN_LINK' ) ) {
	define( 'WCPSCW_PLUGIN_LINK', 'https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=product-slider&utm_campaign=Features-PRO' ); // Plugin Category
}
if( ! defined( 'WCPSCW_SITE_LINK' ) ) {
	define( 'WCPSCW_SITE_LINK', 'https://www.essentialplugin.com' ); // Plugin link
}
/**
 * Load Text Domain

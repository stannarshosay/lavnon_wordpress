...
<h2>
<?php _e( 'How It Works', 'woo-product-slider-and-carousel-with-category' ); ?>
</h2>
	<style type="text/css">
			...
			<div id="post-body-content">
				<div class="meta-box-sortables">
					...
					<div class="postbox">
						<div class="postbox-header">
							<h2 class="hndle">
								<span><?php _e( 'Need Support & Solutions?', 'woo-product-slider-and-carousel-with-category' ); ?></span>
							</h2>
						</div>
						<div class="inside">
							<table class="form-table">
								<tbody>
									<tr>
										<td>
											<p><?php _e('Boost design and best solution for your website.', 'woo-product-slider-and-carousel-with-category'); ?></p> <br/>										
											<a class="button button-primary button-orange" href="<?php echo WCPSCW_SITE_LINK; ?>/essential-bundle/?utm_source=WP&utm_medium=Woo-Product&utm_campaign=Check-Designs-Solutions" target="_blank"><?php _e('Boost Design', 'woo-product-slider-and-carousel-with-category'); ?></a>
										</td>
									</tr>
								</tbody>
							</table>
				...
				<div class="meta-box-sortables">
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							...
							<a class="button button-primary wpos-button-full button-orange" href="<?php echo WCPSCW_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Woo-Product-Slider&utm_campaign=How-It-Work" target="_blank"><?php _e('Go Premium ', 'woo-product-slider-and-carousel-with-category'); ?></a>

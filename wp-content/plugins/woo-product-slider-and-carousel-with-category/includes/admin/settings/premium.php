...
<div class="wrap">
	...
	<h2><?php _e( 'Product Slider and Carousel with Category for WooCommerce with ', 'woo-product-slider-and-carousel-with-category' ); ?><span class="wpos-epb"><?php _e( 'Essential Plugin Bundle', 'timeline-and-history-slider' ); ?></span></h2><br />
					...
					<colgroup></colgroup>
						...
						<tr>
							...
							<th>
								...
								<p>Gain access to <strong>Product Slider and Carousel with Category for WooCommerce</strong> included in <br /><strong class="wpos-epb">Essential Plugin Bundle</strong></p>
								<a href="<?php echo WCPSCW_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Woo-Product-Slider&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a>
							</th>
						</tr>
					</thead>
					 ...
					 <tfoot>
						<tr>
							<th></th>
							<td></td>
							<td><p>Gain access to <strong>Product Slider and Carousel with Category for WooCommerce</strong> included in <br /><strong>Essential Plugin Bundle</strong></p>
							<a href="<?php echo WCPSCW_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Woo-Product-Slider&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a></td>
						</tr>
					</tfoot>
				...
				<!--Upgrad to Pro HTML -->
					<div id="postbox-container-1" class="postbox-container wpos-sidebar">
						<div class="wpos-epb-wrap">
							...
							<ul>
								<li><b>40+ Utility Plugins</b> including <span><?php echo WCPSCWC_NAME; ?> premium </span> version.</li>
							...
							<a class="button-yellow button-orange" style="margin-bottom:0px;" href="<?php echo WCPSCW_SITE_LINK; ?>/essential-bundle/?utm_source=WP&utm_medium=Woo-Product-Slider&utm_campaign=EPB-Upgrade-PRO" target="_blank">Buy Now</a>
						</div>
